...
{
    u.setAddress(swap_endian(u.getAddress()));
    return  u;
}

IPv6& swap_endian(IPv6 &u)
{
    u.setAddress(swap_endian(u.getAddress(0)),
                 swap_endian(u.getAddress(1)),
                 swap_endian(u.getAddress(2)),
                 swap_endian(u.getAddress(3)));
    return u;
}
